...
HD_PWD='C:/Users/hugof/Documents/KU Leuven/FIIW/BAC3/Complex Digital Design/Project Lab/project_lab/project_lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wrap_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wrap_adder.tcl
